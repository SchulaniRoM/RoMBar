LI_Transtext = {
	...
	ADD_LINK = "add", -- Requires localization
	ADD_LINK_HELP = "tutorial", -- Requires localization
	...
	ADDMESSAGE_ADD = "The item: %s has been added to the filter.", -- Requires localization
	ADDMESSAGE_REMOVE = "The item: %s has been deleted from the filter.", -- Requires localization
	ADDONMANAGER_DESCRIPTION = "Automation around the looting.", -- Requires localization
	ALLOW_DICE = "Dices can:", -- Requires localization
	AUTOGREED = "AutoGreed", -- Requires localization
	AUTOLOOT = "AutoLoot", -- Requires localization
	AUTOPASS = "AutoPass", -- Requires localization
	...
	COLLECT = "collect", -- Requires localization
	DEL_BUTTON_TOOLTIP = "Delete this filter.", -- Requires localization
	...
	DISCARD = "remove", -- Requires localization
	...
	EXAMPLE_FILTER_HELP = "Type your filter for testing here.", -- Requires localization
	EXAMPLE_LINK_HELP = "Just make a right click onto an itemlink in the chat or drag the item onto this field to take it for the tutorial.", -- Requires localization
	EXPLAIN_5PLUS4 = "Extension with &-symbol are possible (as under 4)!", -- Requires localization
	EXPLAIN_CLASS = "Currently active main class", -- Requires localization
	EXPLAIN_FILTER1 = "Possibilities", -- Requires localization
	EXPLAIN_FILTER10 = "5) Specific Keywords", -- Requires localization
	EXPLAIN_FILTER11 = [=[!mingold 999 - an object is min. 999 gold worth.
!maxgold 999 - an object is max. 999 gold worth.]=], -- Requires localization
	EXPLAIN_FILTER12 = "More filter suggestions are opposed on Curse.com.", -- Requires localization
	EXPLAIN_FILTER13 = [=[!mindura 99 - the Item durability is min. 99.
!maxdura 99 -  the Item durability is max. 99.]=], -- Requires localization
	EXPLAIN_FILTER14 = "!$Filter - Is applied as $-Filter.", -- Requires localization
	EXPLAIN_FILTER15 = [=[!mincharlevel 99 - the player level is min. 99.
!maxcharlevel 99 - the player level is max. 99.]=], -- Requires localization
	EXPLAIN_FILTER16 = [=[!minitemlevel 99 - the item level is min. 99.
!maxitemlevel 99 - the item level is max. 99.]=], -- Requires localization
...
!maxcount 99 Itemname - Itemname has max. 99 pieces inside the bag.]=], -- Requires localization
	...
	EXPLAIN_FILTER2 = "1) The full name of an item.", -- Requires localization
...
!maxbbcount 99 Itemname - !maxcount for bank + bag.]=], -- Requires localization
	...
	EXPLAIN_FILTER3 = "Only this item is detected. Useful for individual items.", -- Requires localization
	EXPLAIN_FILTER4 = "2) A part of the name , \"wildcard\" - *", -- Requires localization
	EXPLAIN_FILTER5 = "Many items are detected. The *can be replaced by an arbitrary rest. Useful for items with similar names and function, such as potions.", -- Requires localization
	EXPLAIN_FILTER6 = "3) Browse the subject-matter, such as type, stat, or similar. - $", -- Requires localization
	EXPLAIN_FILTER7 = "The object is scanned and recognized. This filter finds for example runes.", -- Requires localization
	EXPLAIN_FILTER8 = "4) Browse the subject with several competency, such as type and Stat -$&", -- Requires localization
	EXPLAIN_FILTER9 = "The object is scanned and recognized. This filter is for example Tier 2 Runes.", -- Requires localization
...
§ filters needs one of these additional commands < > <= >= == ~= and a number e.g. %s
	...
	EXPLAIN_FILTERWARNING = "Deleted items can not be get back.", -- Requires localization
	EXPLAIN_PIPE = "With a Pipe | a filter can be abnegated.", -- Requires localization
	EXPLAIN_QUALITY = "Rarity: %s", -- Requires localization
	GOLDDIGGER_AUTOINACTIVE = "There is no item to delete. The gold digger-option is inactive.", -- Requires localization
	HELP_FILTER = "Testfilter", -- Requires localization
	HELP_ITEMLINK = "Itemlink", -- Requires localization
	INACTIVE = "Inactive", -- Requires localization
	ITEMFILTER = "Itemfilter", -- Requires localization
	ITEMOFFICER = "Officer", -- Requires localization
	LOADED = "successfully loaded", -- Requires localization
	...
	LOOT = "loot", -- Requires localization
	LOOT_BUTTON_TOOLTIP = "What subject-specific loot rule should be used?", -- Requires localization
	LOOTOMATIC_CONVERTED = "Lootomatic filter settings successfully applied.", -- Requires localization
	MANUAL = "manual", -- Requires localization
...
The loot threshold should be %s.]=], -- Requires localization
	NEVER = "never", -- Requires localization
	NEXTSTAT = [=[Stat-Rota: This stat is for %s.
(%s)]=], -- Requires localization
	NO_BOSSES = "no bosses", -- Requires localization
	...
	OPTION_HEADLINE_ACTIVE = "active", -- Requires localization
	OPTION_HEADLINE_ADDMESSAGE = "Chat messages", -- Requires localization
	OPTION_HEADLINE_ASKAFTER = "Confirm items in the stack from %s", -- Requires localization
	OPTION_HEADLINE_AUTODKP = "Auto confirmation", -- Requires localization
	OPTION_HEADLINE_BAGBUTTON = "Bagbutton", -- Requires localization
	OPTION_HEADLINE_CLOSE = "Close after loot", -- Requires localization
	OPTION_HEADLINE_COUNTAMMO = "%s ammo = 1 item", -- Requires localization
	OPTION_HEADLINE_CURSOR = "Follow cursor", -- Requires localization
	OPTION_HEADLINE_DELAY = "Delay: %s s", -- Requires localization
	OPTION_HEADLINE_HISTORY = "History", -- Requires localization
	OPTION_HEADLINE_HISTORYNUM = "Number of shown history-items: %s", -- Requires localization
	OPTION_HEADLINE_IMPROVETOOLTIPS = "Dice tooltips", -- Requires localization
	OPTION_HEADLINE_MINIMAP = "Minimap-button", -- Requires localization
	OPTION_HEADLINE_NOFILTER = "No filters", -- Requires localization
	OPTION_HEADLINE_NOSCANTIP = "Hide tooltips", -- Requires localization
	OPTION_HEADLINE_OTHERSTYLE = "Lootomatic-style", -- Requires localization
	OPTION_HEADLINE_RANGE = "range", -- Requires localization
	OPTION_HEADLINE_READONLY = "Readonly", -- Requires localization
	OPTION_HEADLINE_REMOVELESSGOLD = "Gold digger", -- Requires localization
	OPTION_HEADLINE_SAVEQUEST = "Special items", -- Requires localization
	OPTION_HEADLINE_SECUWAIT = "Cancel after %s s", -- Requires localization
	OPTION_HEADLINE_STATROTA = "Stat-Rotation", -- Requires localization
	OPTION_HEADLINE_TESTING = "Testing", -- Requires localization
	OPTIONS_HEADLINE_MOVEBUTTON = "move dice-window", -- Requires localization
	OPTIONS_HEADLINE_ROLLBUTTON = "Dice-result displays", -- Requires localization
	OPTION_TOOLTIP_ACTIVE = "Activates LootIt.", -- Requires localization
	OPTION_TOOLTIP_ADDMESSAGE = "Appropriate messages are shown in chat when you edit the filter settings.", -- Requires localization
	OPTION_TOOLTIP_ASKAFTER = "Should a stack with at least as many items as set should be discarded, a security question is shown.", -- Requires localization
	...
	OPTION_TOOLTIP_CLOSE = "The looting-window is closed immediately after the automatic loot.", -- Requires localization
	OPTION_TOOLTIP_COUNTAMMO = "So many ammunition are regarded as 1 item. This flows into the security question.", -- Requires localization
	OPTION_TOOLTIP_CURSOR = "A new looting-window opens directly to the mouse pointer.", -- Requires localization
	OPTION_TOOLTIP_DELAY = "This delay describes, how long you see a roll-window, until the intended action is used.", -- Requires localization
	OPTION_TOOLTIP_HISTORY = "Displays a history of all items received in the group.", -- Requires localization
	OPTION_TOOLTIP_HISTORYNUM = "If the history is too long you can limit its number of items at this point.", -- Requires localization
	OPTION_TOOLTIP_IMPROVETOOLTIPS = "Expanded notes for the keyboard shortcuts onto the dice tooltips.", -- Requires localization
	OPTION_TOOLTIP_MINIMAP = "Show/Hide the Minimap-button.", -- Requires localization
	OPTION_TOOLTIP_NOFILTER = "If you loot items no filters are applied any more, only the AutoLoot rule is used.", -- Requires localization
	...
	OPTION_TOOLTIP_OTHERSTYLE = "Gives out the dice results in chat with the good old Lootomatic-Style.", -- Requires localization
	...
	OPTION_TOOLTIP_REMOVELESSGOLD = "If the backpack has less than three free slots, the cheapest, which are not covered by an item-specific filter will be deleted.", -- Requires localization
	OPTION_TOOLTIP_SAVEQUEST = "Quest items, unique items, and item shop items are deleted only after a security question, besides there is an item-specific filter.", -- Requires localization
	OPTION_TOOLTIP_SECUWAIT = "Before the security question is closed automatically and the deleting is canceled, this number of seconds will be waited.", -- Requires localization
...
Manual means that items are not looted or diced.]=], -- Requires localization
	...
	PLUGIN_NAME = "LootIt!", -- Requires localization
	PLUGIN_USER = "Right-click: open context menu.", -- Requires localization
	...
	RESULTWINDOW_HEADLINE = "Show?", -- Requires localization
	ROLL = "roll", -- Requires localization
	ROLL_BUTTON_TOOLTIP = "What subject-specific dice rule should be used?", -- Requires localization
	ROLLRESULT_TOOLTIP = "Set whether the roll results of this rarity is displayed in the chat window.", -- Requires localization
	ROLLRESULT_TOOLTIP_LOG = "Set whether items of this rarity are added to the history.", -- Requires localization
	ROLLRESULT_TOOLTIP_LOOT = "Set, whether loot-messages for this rarity are displayed in the chat.", -- Requires localization
	ROLLRESULT_TOOLTIP_NOLOG = "Set whether items of  this rarity are deleted from the history after distributing to the group automatically.", -- Requires localization
	SEND_TO_WEB = "Transfer data", -- Requires localization
	SPENDGUILD = "Spend guild", -- Requires localization
	...
	TOOLTIP_HELPBUTTON = "show filter-tutorial", -- Requires localization
...
In addition, if CTRL is pressed, it is added to this the general filter.]=], -- Requires localization
	...
	TUTORIAL_ADD_BUTTON = "Apply filter to the filter-list.", -- Requires localization
	TUTORIAL_ALL1 = [=[Start simply with a filter. Suggestions are displayed immediately.
Try something to understand the filter.]=], -- Requires localization
	TUTORIAL_ALL2 = [=[%s - Wildcard/Joker
%s - search into the tooltip
%s - Community-Filter

%s to combine multiple filters.]=], -- Requires localization
	TUTORIAL_COMMUNITY = [=[Many filtering options are available only here.
Simply enter the filter name and additional information.]=], -- Requires localization
	TUTORIAL_DOLLER = [=[The following word is searched into the tooltip.
Only exact matches will be accepted unless if it is a *-Symbol used.]=], -- Requires localization
	TUTORIAL_FOUND = "The filter is applicable to the item!", -- Requires localization
	TUTORIAL_NOT_FOUND = "The filter is NOT applicable to the item!", -- Requires localization
	TUTORIAL_TOO_SHORT = "Filter is too short!", -- Requires localization
	TUTORIAL_WILDCARD = "The *-Symbol replaces any character string.", -- Requires localization
	UNKNOWN_COMMAND = "Unknown command", -- Requires localization
	UPDATE_MESSAGE = "New version successfully detected!", -- Requires localization
	VERSION = "version", -- Requires localization
	...
	ZONENAME = "name of the zone or instance.", -- Requires localization
}
