...
local len, lend = string.find("v1.92beta1", "%d+%.%d+")

if string.find("v1.92beta1", "g") then
	lend = string.find("v1.92beta1", "g") - 2
end

local LI = {
	version = string.sub("v1.92beta1", len or 1, lend or 17),
	Path = "Interface/Addons/RoMBar/advanced/LootIt_modified/",
	Language = "EN",
}
